...
**v1.5.0** — 安全加固 + UI 完善（2026-07-15）

安全审查后修复：TOCTOU 竞态修复 ×2 + 崩溃日志迁移 + PII 清理 + .gitignore 全面更新 + `_escape_vbs_path` 重命名。UI 四级字体层级 + 暗色模式警告适配 + Radio/Checkbox 字号统一。见 `versions/v1.5.0/CHANGELOG.md`。
