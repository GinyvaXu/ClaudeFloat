...
class SettingsDialog(QDialog):
    ...
    def _setup_ui(self):
        ...
        # 启动方式
        box = QGroupBox("启动方式")
        box.setFont(self._font(12, bold=True))
        ...
        box_theme.setFont(self._font(12, bold=True))
        ...
        # 大小
        box2 = QGroupBox("浮窗大小")
        box2.setFont(self._font(12, bold=True))
        ...
        # 透明度
        box3 = QGroupBox("透明度")
        box3.setFont(self._font(12, bold=True))
        ...
        box_snap.setFont(self._font(12, bold=True))
        ...
        box4.setFont(self._font(12, bold=True))
